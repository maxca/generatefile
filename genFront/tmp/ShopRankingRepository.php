...
class ShopRankingRepository extends BaseRepositoryWrap
{
    /**
     * set title name default
     * @var string
     */
    protected $name = 'shop-ranking';
    ...
    protected $configEndpoint = [
        'list' => '/shop-ranking/list',
        'create' => '/shop-ranking/create',
        'update' => '/shop-ranking/update',
        'delete' => '/shop-ranking/delete',
    ];
    ...
    protected $configView = [
        'list' => 'shopranking.list',
        'edit' => 'shopranking.edit',
        'create' => 'shopranking.create',
        'detail' => 'shopranking.detail',
    ];
