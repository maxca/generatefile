 ...
 */
namespace App\Repository\ShippingAddress;

use App\Repository\BaseRepositoryWrap;

class ShippingAddressRepository extends BaseRepositoryWrap
{
    /**
     * set title name default
     * @var string
     */
    protected $name = 'shipping-address';
    ...
    protected $configEndpoint = [
        ...
        'create' => '/shipping-address/create',
        'update' => '/shipping-address/update',
    ...
    protected $configView = [
        ...
        'edit' => 'shippingaddress.edit',
        'create' => 'shippingaddress.create',
