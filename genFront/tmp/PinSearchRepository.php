 ...
 */
namespace App\Repository\PinSearch;
...
class PinSearchRepository extends BaseRepositoryWrap
{
    ...
    protected $configEndpoint = [
        'list' => '/pin-search/list',
        'create' => '/pin-search/create',
        'update' => '/pin-search/update',
        'delete' => '/pin-search/delete',
    ];
