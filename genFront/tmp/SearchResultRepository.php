 ...
 */
namespace App\Repository\SearchResult;

use App\Repository\BaseRepositoryWrap;

class SearchResultRepository extends BaseRepositoryWrap
{
    /**
     * set title name default
     * @var string
     */
    protected $name = 'search-result';
    ...
    protected $configEndpoint = [
        ...
        'create' => '/search-result/create',
        'update' => '/search-result/update',
        'delete' => '/search-result/delete',
    ];
