...
class ProductWishlistRepository extends BaseRepositoryWrap
{
    /**
     * set title name default
     * @var string
     */
    protected $name = 'product-wishlist';
    ...
    protected $configEndpoint = [
        'list' => '/product-wishlist/list',
        'create' => '/product-wishlist/create',
        'update' => '/product-wishlist/update',
        'delete' => '/product-wishlist/delete',
    ];
    ...
    protected $configView = [
        ...
        'edit' => 'productwishlist.edit',
        'create' => 'productwishlist.create',
        'detail' => 'productwishlist.detail',
    ];
